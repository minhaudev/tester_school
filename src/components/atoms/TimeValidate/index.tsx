...
function TimeValidate({
    ...
    const color = currentPercent >= 50  ? '#69AA43' : (currentPercent >= 30  && currentPercent < 50) ?'#F5BF00' : "#ED1E24"
    return (
        <div>
            <svg
                width={width}
                ...
                <path
                    ...
                    fill={`${currentPercent >= 20 && currentPercent > 10 ?color: disableColor}`}
                />
                <path
                    ...
                    fill={`${currentPercent >= 30 && currentPercent > 20 ?color : disableColor}`}
                />
                <path
                    ...
                    fill={`${currentPercent >= 40 && currentPercent > 30 ? color : disableColor}`}
                />
                <path
                    ...
                    fill={`${currentPercent >= 50 && currentPercent > 40 ? color : disableColor}`}
                />
                <path
                    d="M20 40C15.9908 40 12.0742 38.7951 8.75833 36.5416L11.5688 32.4062C14.0557 34.0963 16.9931 35 20 35V40Z"
                    fill={`${currentPercent >= 60 && currentPercent > 50 ? color : disableColor}`}
                />
                <path
                    ...
                    fill={`${currentPercent >= 70 && currentPercent > 60 ? color : disableColor}`}
                />
                <path
                    ...
                    fill={`${currentPercent >=  80 && currentPercent > 70 ? color : disableColor}`}
                />
                <path
                    ...
                    fill={`${currentPercent >=  90 && currentPercent > 80 ? color : disableColor}`}
                />
                <path
                    ...
                    fill={`${currentPercent <= 100 && currentPercent > 90 ? color : disableColor}`}
                />
            </svg>
        </div>
    );
