        ...
        <div>
            <svg
                ...
                <path
                    ...
                    fill={`${currentTime > 0 ? "#ED8400" : "#E4E4E4"}`}
                />
                <path
                    ...
                    fill={`${currentTime > itemTime * 2 ? "#ED8400" : "#E4E4E4"}`}
                />
                <path
                    ...
                    fill={`${currentTime > itemTime * 3 ? "#ED8400" : "#E4E4E4"}`}
                />
                <path
                    ...
                    fill={`${currentTime > itemTime * 4 ? "#ED8400" : "#E4E4E4"}`}
                />
                <path
                ...
                <path
                    ...
                    fill={`${currentTime > itemTime * 7 ? "#ED8400" : "#E4E4E4"}`}
                />
                <path
                    ...
                    fill={`${currentTime > itemTime * 8 ? "#ED8400" : "#E4E4E4"}`}
                />
                <path
                    ...
                    fill={`${currentTime > itemTime * 9 ? "#ED8400" : "#E4E4E4"}`}
                />
                <path
                    ...
                    fill={`${currentTime >= itemTime * 10 ? "#ED8400" : "#E4E4E4"}`}
                />
            </svg>
        </div>
    );
