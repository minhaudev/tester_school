...
function TimeValidate({
    ...
    const itemTime = totalTime / 10;
    const color = currentTime > itemTime * 5 ? '#69AA43' : (currentTime >= itemTime * 3 && currentTime <= itemTime*5) ?'#F5BF00' : "#ED1E24"
    return (
        <div>
            <svg
                width={width}
                ...
                <path
                    ...
                    fill={`${currentTime > 0 ? color : disableColor}`}
                />
                <path
                    ...
                    fill={`${currentTime > itemTime * 2 ?color: disableColor}`}
                />
                <path
                    ...
                    fill={`${currentTime > itemTime * 3 ?color : disableColor}`}
                />
                <path
                    ...
                    fill={`${currentTime > itemTime * 4 ? color : disableColor}`}
                />
                <path
                ...
                <path
                    ...
                    fill={`${currentTime > itemTime * 7 ? color : disableColor}`}
                />
                <path
                    ...
                    fill={`${currentTime > itemTime * 8 ? color : disableColor}`}
                />
                <path
                    ...
                    fill={`${currentTime > itemTime * 9 ? color : disableColor}`}
                />
                <path
                    ...
                    fill={`${currentTime >= itemTime * 10 ? color : disableColor}`}
                />
            </svg>
        </div>
    );
