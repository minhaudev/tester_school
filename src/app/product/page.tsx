...
const Product = () => {
    ...
    const tdClasses = twMerge(
        tableClasses,
        "text-text text-[13px] font-normal leading-[15.51px] px-2"
    );
    ...
    const handleRecordsPerPageChangeWrapper = (
        tableId: string,
        newRecordsPerPage: number
    ) => {
                ...
                <DataTable className="w-full" tableId={""}>
                    <thead className="bg-white">
                        <tr className="flex flex-row  ">
                            <th
                                className={`${thClasses} min-w-[55px] border-l-0 px`}>
                                No
                            </th>
                            ...
                            <th
                                className={`${thClasses} min-w-[93px] flex-col`}>
                                Total coil
                                <span className="text-unit">(PCS)</span>
                            </th>
                            <th
                                className={`${thClasses} min-w-[119px] flex-col`}>
                                Total weight
                            ...
                            <th
                                className={`${thClasses} min-w-[120px] flex-col`}>
                                Unit price
                                <span className="text-unit">(PCS)</span>
                            </th>
                            <th
                    ...
                    <tbody>
                        {tables.table1.data.map((item) => {
                            return (
                                <tr
                                    key={item.id}
                                    className="flex flex-row odd:bg-highlight even:bg-white  ">
                                    <td
                                        className={`${tdClasses} min-w-[55px] border-l-0`}>
                                        {item.No}
                                    </td>
                                    ...
                                    <td
                                        className={`${tdClasses} flex-1 !justify-start`}>
                                        {item.Specifications}
                                    </td>
                                    <td
                                        className={`${tdClasses} min-w-[212px] !px-0`}
                                        colSpan={2}>
                                    ...
                                    <td
                                        className={`${tdClasses} min-w-[113px]`}>
                                        <select
                                    ...
                                    <td
                                        className={`${tdClasses} min-w-[158px]`}></td>
                                    <td
                                        className={`${tdClasses} min-w-[120px] `}>
                                    ...
                                    <td
                                        className={`${tdClasses} min-w-[115px] gap-2`}>
            ...
            <div className="flex flex-row my-4 bg-highlight p-4 items-center justify-between">
                ...
                <div className="flex flex-col gap-1">
                    <PaginationSelect
                        ...
                        recordsPerPage={
                            paginationStates["table2"].recordsPerPage
                        }
            ...
            <div className=" py-4">
                <DataTable className="w-full" tableId={tables.table2.id}>
                        ...
                        <tr className="flex flex-row text-primary min-h-[48px] text-[12px] font-semibold">
                            ...
                            <th className={`w-[15%]  ${th2Classes}`}>
                                ...
                                <Sort
                                    ...
                                    onClick={() =>
                                        handleSort("table2", "propertieStatus")
                                    }
                                />
                            </th>
                            ...
                            <th className={`w-[15%] ${th2Classes}`}>
                                ...
                                <Sort
                                    className={`size-4 hover:cursor-pointer`}
                                    onClick={() =>
                                        handleSort("table2", "propertieTitle")
                                    }
                                />
                            </th>
                    ...
                    <tbody>
                        {getSortedData(
                            "table2",
                            paginatedData("table2", tables.table2.data)
                        ).map((row) => {
            ...
            <div className="flex flex-row my-4 bg-highlight p-4 items-center justify-between">
                ...
                <div className="flex flex-col gap-1">
                    <PaginationSelect
                        ...
                        recordsPerPage={
                            paginationStates["table3"].recordsPerPage
                        }
                        arrRecordsPerPage={[2, 5, 10]}
                        handlePageChange={(tableId, newPage) =>
                            handlePageChange(tableId, newPage)
            ...
            <div className=" py-4">
                <DataTable className="w-full" tableId={tables.table3.id}>
                        ...
                        <tr className="flex flex-row text-primary min-h-[48px] text-[12px] font-semibold">
                            ...
                            <th className={`w-[15%]  ${th2Classes}`}>
                                ...
                                <Sort
                                    className={`size-4 hover:cursor-pointer`}
                                    onClick={() =>
                                        handleSort("table3", "propertieStatus")
                                    }
                                />
                            </th>
                            <th className={`flex-1  ${th2Classes}`}>
                            ...
                            <th className={`w-[15%] ${th2Classes}`}>
                                ...
                                <Sort
                                    className={`size-4 hover:cursor-pointer`}
                                    onClick={() =>
                                        handleSort("table3", "propertieTitle")
                                    }
                                />
                            </th>
                            <th className={`w-[11%] ${th2Classes}`}>
                    ...
                    <tbody>
                        {getSortedData(
                            "table3",
                            paginatedData("table3", tables.table3.data)
                        ).map((row) => (
                            <tr
                                key={row.id}
                                className="flex flex-row font-normal w-full">
                                <td className={`w-[3%] ${td2Classes} flex-col`}>
                                    <Checkbox
                                        description=""
                                        id={row.id}
                                        className="h-5 w-5"
                                        checked={
                                            selectedItems["table3"]?.includes(
                                                row.id
                                            ) || false
                                        }
                                        onChange={() =>
